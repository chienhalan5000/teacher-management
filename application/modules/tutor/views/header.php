...
<head>
	...
	<link href = "<?php echo base_url('assets/images/eduplay.png') ?>" rel = "shortcut icon" type = "image/x-icon"/>
	<link href = "<?php echo base_url('assets/images/loading.gif') ?>" rel = "shortcut icon" type = "image/x-icon"/>
	<!-- Global stylesheets -->
